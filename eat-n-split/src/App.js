  ...
  return (
    <div className="app">
      <div className="sidebar">
        <Frindlist friends={friends} selectedFriend={selectedFriend} onSelection={handleSelection} />
...
function Frindlist({ friends, onSelection, selectedFriend }) {
  return (
    <ul>
      {friends.map((friend) => (
...
function FormAddFriend({ onAddFriend }) {
  ...
  function handleSubmit(e) {
    ...
    setName("")
    setImage("https://i.pravatar.cc/48?u=545")
